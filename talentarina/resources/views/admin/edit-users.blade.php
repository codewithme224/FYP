                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="forms-sample" method="POST" action="{{ route('update-users', $user->id) }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" name="email" class="form-control mb-2"
                                                id="exampleInputEmail2" autocomplete="off" value="{{$user->email}}"> 
                                                @if ($errors->has('email'))
                                                        <div class="alert alert-danger" role="alert">
                                                            {{ $errors->first('email') }}
                                                        </div>
                                    ...
                                    <a href="{{ route('all.users') }}" class="btn btn-light">Cancel</a>
                                    </div>
                                </form>
